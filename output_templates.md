...
Add only light execution detail that affects the top action, validation logic, or roadmap. Public `--detailed` may make actions slightly more executable. Keep it under 5,000 UTF-8 bytes.
```
